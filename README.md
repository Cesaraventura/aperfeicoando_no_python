Projeto de aperfeiçoamento no Python para fortalecer o conhecimento na lógica de programação através da linguagem. As atividades desse projeto são baseadas no curso de Python do Guanabara.
